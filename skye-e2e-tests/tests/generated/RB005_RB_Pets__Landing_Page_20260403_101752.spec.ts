I'll create a PetsPage class under the pages folder and then use it in the test.

**File 1: pages/PetsPage.ts**
...
export default class PetsPage extends BasePage {
    ...
    constructor(page: Page) {
        super(page);
        this.navigationMenu = page.getByTestId('sk-nav-menu');
    ...
    async openNavigationMenu(): Promise<void> {
        await this.navigationMenu.waitFor({ state: 'visible', timeout: 30000 });
...
**File 2: tests/generated/RB005_PetsLandingPage.spec.ts**
